# Es wird angenommen, dass UWB kein Abfluss hat (wie ein Reservoir)
# (also, in timeseries_import.csv ist fuer alle Zeiten Q_KBW_2 = 0.0 )

# das Pumpen von TSP nach UWB wird hier maximiert
...
class Example(CSVMixin, ModelicaMixin, CollocatedIntegratedOptimizationProblem):
    ...
    def objective(self, ensemble_member):
        ...
        return -1*self.integral('Q_KBW', ensemble_member)
    ...
    def path_constraints(self, ensemble_member):
        ...
        constraints.append((self.state('TSP.HQ.H'), 0.2, 0.6))

        constraints.append((self.state('UWB.HQ.H'), 0.2, 2.0))
