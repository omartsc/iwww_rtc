...
class Example(GoalProgrammingMixin, CSVMixin, ModelicaMixin,
    ...
    def constraints(self, ensemble_member):
        ...
        constraints.append((self.state_at('storage.HQ.H', 1.0, ensemble_member), 0.40, 0.40 + schneerckl))
        constraints.append((self.state_at('storage.HQ.H', 2.0, ensemble_member), 0.40, 0.40 + schneerckl))
        constraints.append((self.state_at('storage.HQ.H', 3.0, ensemble_member), 0.40, 0.40 + schneerckl))
        constraints.append((self.state_at('storage.HQ.H', 4.0, ensemble_member), 0.40, 0.40 + schneerckl))
